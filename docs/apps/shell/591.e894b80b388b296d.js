(self["webpackChunkshell"] = self["webpackChunkshell"] || []).push([[591],{
...
const useSyncExternalStore = "useSyncExternalStore" in index_js_ ? (module => module.useSyncExternalStore)(index_js_) : shim;

// Contexts for data routers
const DataStaticRouterContext = /*#__PURE__*/index_js_.createContext(null);
...
function useMatch(pattern) {
  ...
  return index_js_.useMemo(() => matchPath(pattern, pathname), [pathname, pattern]);
}
/**
...
function useRoutes(routes, locationArg) {
  !useInRouterContext() ?  false ? 0 : invariant(false) : void 0;
  let dataRouterStateContext = index_js_.useContext(DataRouterStateContext);
  let {
...
function DefaultErrorElement() {
  ...
  return /*#__PURE__*/index_js_.createElement(index_js_.Fragment, null, /*#__PURE__*/index_js_.createElement("h2", null, "Unhandled Thrown Error!"), /*#__PURE__*/index_js_.createElement("h3", {
    style: {
      fontStyle: "italic"
    }
  }, message), stack ? /*#__PURE__*/index_js_.createElement("pre", {
    style: preStyles
  }, stack) : null, /*#__PURE__*/index_js_.createElement("p", null, "\uD83D\uDCBF Hey developer \uD83D\uDC4B"), /*#__PURE__*/index_js_.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own\xA0", /*#__PURE__*/index_js_.createElement("code", {
    style: codeStyles
  }, "errorElement"), " props on\xA0", /*#__PURE__*/index_js_.createElement("code", {
    style: codeStyles
  }, "<Route>")));
}
...
class RenderErrorBoundary extends index_js_.Component {
  ...
  render() {
    return this.state.error ? /*#__PURE__*/index_js_.createElement(RouteErrorContext.Provider, {
...
function RenderedRoute(_ref) {
  ...
  let dataStaticRouterContext = index_js_.useContext(DataStaticRouterContext); // Track how deep we got in our render pass to emulate SSR componentDidCatch
...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    let errorElement = dataRouterState ? match.route.errorElement || /*#__PURE__*/index_js_.createElement(DefaultErrorElement, null) : null;

    let getChildren = () => /*#__PURE__*/index_js_.createElement(RenderedRoute, {
      match: match,
      routeContext: {
        outlet,
    ...
    return dataRouterState && (match.route.errorElement || index === 0) ? /*#__PURE__*/index_js_.createElement(RenderErrorBoundary, {
...
function useMatches() {
  ...
  return index_js_.useMemo(() => matches.map(match => {
    let {
      pathname,
      params
...
function RouterProvider(_ref) {
  ...
  return /*#__PURE__*/index_js_.createElement(DataRouterContext.Provider, {
    value: {
      router,
      navigator,
      static: false,
    ...
    navigator: navigator
  }, router.state.initialized ? /*#__PURE__*/index_js_.createElement(Routes, null) : fallbackElement)));
}
...
function MemoryRouter(_ref2) {
  ...
  let [state, setState] = index_js_.useState({
    action: history.action,
    location: history.location
  });
  index_js_.useLayoutEffect(() => history.listen(setState), [history]);
...
function Navigate(_ref3) {
  ...
  !useInRouterContext() ?  false ? 0 : invariant(false) : void 0;
   false ? 0 : void 0;
  let dataRouterState = index_js_.useContext(DataRouterStateContext);
...
function Router(_ref4) {
  ...
  let location = index_js_.useMemo(() => {
...
function Routes(_ref5) {
  ...
  let dataRouterContext = index_js_.useContext(DataRouterContext); // When in a DataRouterContext _without_ children, we use the router routes
...
const Link = /*#__PURE__*/index_js_.forwardRef(function LinkWithRef(_ref4, ref) {
  let {
    onClick,
    relative,
    reloadDocument,
...
const NavLink = /*#__PURE__*/index_js_.forwardRef(function NavLinkWithRef(_ref5, ref) {
  let {
  ...
  let nextMatch = index_js_.useMemo(() => nextLocation ? matchPath({
    path: path.pathname,
    end,
    caseSensitive
...
const Form = /*#__PURE__*/index_js_.forwardRef((props, ref) => {
  return /*#__PURE__*/index_js_.createElement(FormImpl, react_router_dom_dist_extends({}, props, {
    ref: ref
  }));
});
...
const FormImpl = /*#__PURE__*/index_js_.forwardRef((_ref6, forwardedRef) => {
  let {
    reloadDocument,
    replace,
...
function useSearchParams(defaultInit) {
  ...
  let location = useLocation();
  let searchParams = index_js_.useMemo(() => getSearchParamsForLocation(location.search, defaultSearchParamsRef.current), [location.search]);
  let navigate = useNavigate();
...
function useFetcher() {
  ...
  !(routeId != null) ?  false ? 0 : invariant(false) : void 0;
  let [fetcherKey] = index_js_.useState(() => String(++fetcherId));
  let [Form] = index_js_.useState(() => {
    !routeId ?  false ? 0 : invariant(false) : void 0;
    return createFetcherForm(fetcherKey, routeId);
  });
  let [load] = index_js_.useState(() => href => {
...
function useScrollRestoration(_temp3) {
  ...
  useBeforeUnload(index_js_.useCallback(() => {
